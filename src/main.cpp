...
int64 nStartRewardTime = 1493113361; //1475020800
...
bool CTransaction::CheckTransaction(CValidationState &state, uint256 hashTx, bool isVerifyDB, int nHeight) const
{
    ...
    if (IsCoinBase())
    {
        ...
        if ((nHeight > 200000) && (nHeight < 840000)) {
            ...
            if(!fTestNet && (GetAdjustedTime() > nStartRewardTime)){
                FOUNDER_1_SCRIPT.SetDestination(CBitcoinAddress("B5Hg3DRzWZ6PAbFYt9iqYBtc4yXcQKnVgG").Get());
                FOUNDER_2_SCRIPT.SetDestination(CBitcoinAddress("BPRDc3vopCJ3ikvzsW4cFdsbqzbyUZ29Yu").Get());

                FOUNDER_3_SCRIPT.SetDestination(CBitcoinAddress("BGiZtxPD9kg7rxjjW4bMSBBqSoyBQTzXGe").Get());
                FOUNDER_4_SCRIPT.SetDestination(CBitcoinAddress("BJD7skrVNYsT2BkBjub5LyULRCvSQ7DQaT").Get());
                FOUNDER_5_SCRIPT.SetDestination(CBitcoinAddress("BHpC5j7G6Lkssu1cWc4t7Nuid3H5rUD2zC").Get());
                ...
                FOUNDER_1_SCRIPT.SetDestination(CBitcoinAddress("TUXtzcwE1rEZkZ4KBBcsotUoLZiKJfhi5F").Get());
                FOUNDER_2_SCRIPT.SetDestination(CBitcoinAddress("TX94ecRJ96weVJvV7iHXKj1BgTmePiu24X").Get());
                FOUNDER_3_SCRIPT.SetDestination(CBitcoinAddress("TDLUPuTJiAGQxwdLGoaDzkzEH8gFbXUm3r").Get());
                FOUNDER_4_SCRIPT.SetDestination(CBitcoinAddress("TVLXXFmXjNg3w5qdaottMzRRcY7jSGxLR7").Get());
                FOUNDER_5_SCRIPT.SetDestination(CBitcoinAddress("TBTGrVzRSKYKz4hNwD4AwbxmG5eUuRiAbA").Get());
            }

            BOOST_FOREACH(const CTxOut& output, vout) {
                if (output.scriptPubKey == FOUNDER_1_SCRIPT && output.nValue == (int64)(0.35 * COIN)) {
                    found_1 = true;
                }
                if (output.scriptPubKey == FOUNDER_2_SCRIPT && output.nValue == (int64)(0.35 * COIN)) {
                    found_2 = true;
                }
                if (output.scriptPubKey == FOUNDER_3_SCRIPT && output.nValue == (int64)(0.35 * COIN)) {
                    found_3 = true;
                }
                if (output.scriptPubKey == FOUNDER_4_SCRIPT && output.nValue == (int64)(0.35 * COIN)) {
                    found_4 = true;
                }
                if (output.scriptPubKey == FOUNDER_5_SCRIPT && output.nValue == (int64)(0.35 * COIN)) {
                    found_5 = true;
                }
            }
...
CBlockTemplate* CreateNewBlock(const CScript& scriptPubKeyIn)
{
    ...
    if ((pindexBest->nHeight+1 > 200000) && (pindexBest->nHeight+1 < 840000)) {

         // Take some reward away from us
         txNew.vout[0].nValue = -1.75 * COIN;
         ...
         txNew.vout.push_back(CTxOut(0.35 * COIN, CScript(FOUNDER_1_SCRIPT.begin(), FOUNDER_1_SCRIPT.end())));
         txNew.vout.push_back(CTxOut(0.35 * COIN, CScript(FOUNDER_2_SCRIPT.begin(), FOUNDER_2_SCRIPT.end())));
         txNew.vout.push_back(CTxOut(0.35 * COIN, CScript(FOUNDER_3_SCRIPT.begin(), FOUNDER_3_SCRIPT.end())));
         txNew.vout.push_back(CTxOut(0.35 * COIN, CScript(FOUNDER_4_SCRIPT.begin(), FOUNDER_4_SCRIPT.end())));
         txNew.vout.push_back(CTxOut(0.35 * COIN, CScript(FOUNDER_5_SCRIPT.begin(), FOUNDER_5_SCRIPT.end())));
