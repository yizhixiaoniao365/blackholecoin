    ...
    prevBlocks(0)
{
    ...
    setWindowTitle(tr("blackholecoin") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a blackholecoin address"));
    ...
    browserAction->setStatusTip(tr("blackholecoin block explorer"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About blackholecoin"), this);
    aboutAction->setStatusTip(tr("Show information about blackholecoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/icons/qtlogo64"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for blackholecoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your blackholecoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified blackholecoin addresses"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("blackholecoin client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to blackholecoin network", "", count));
}
...
{
    QString strTitle = tr("blackholecoin"); // default title
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            message(tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid blackholecoin address or malformed URI parameters."),
